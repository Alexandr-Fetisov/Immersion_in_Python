...
class Matrix:
    ...
    def __init__(self, matrix: list):
        """Конструктор класса. Инициализирует матрицу"""
        self.matrix = matrix
    ...
    def __eq__(self, other: 'Matrix') -> bool:
        """Проверка матрицы на равенство с другой матрицей."""
        return self.matrix == other.matrix

    def __add__(self, other: 'Matrix') -> 'Matrix':
        """Сумма текущей матрицы с другой матрицей."""
    ...
    def __mul__(self, other: 'Matrix') -> 'Matrix':
        """Произведение текущей матрицы на другую матрицу."""
...
if __name__ == '__main__':
    ...
    if matrix2 == matrix3:
        print("Матрицы 2 и 3 равны.")
    else:
        print("Матрицы 2 и 3 не равны.")

    result_sum = matrix1 + matrix2 + matrix3
    print("Сумма матриц:")
    result_sum.print_matrix()

    result_mul = matrix1 * matrix2 * matrix3
