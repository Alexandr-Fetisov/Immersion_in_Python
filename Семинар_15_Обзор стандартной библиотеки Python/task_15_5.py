...
from task_15_4 import text_to_date
import argparse
...
if __name__ == '__main__':
    ...
    # запуск с командной строки: python Семинар_15_Обзор стандартной библиотеки Python/task_15_5.py -count='3-я' -weekday='среда'
    # запуск с командной строки: python Семинар_15_Обзор стандартной библиотеки Python/task_15_5.py -count='3-я' -weekday=3
    # запуск с командной строки: python Семинар_15_Обзор стандартной библиотеки Python/task_15_5.py -count='3-я' -weekday=3 - month=3
