...
logging.basicConfig(level=logging.INFO, filename='task7.log', encoding='utf-8',
                    format=FORMAT, style='{')
...
if __name__ == '__main__':
    ...
    print(get_number(500, 6))
    print(get_number(500, 2))

    # Реализация из командной строки
    # print(parser_func())
    # Пример написания в командной строке: python Python\Seminar_15\hw_15\task.py --number 100 --mod 2
